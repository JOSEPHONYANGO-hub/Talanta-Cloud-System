...
import { Crown, ShieldCheck, User, UserPlus, Trash2, UserCog, Users } from "lucide-react";
                ...
                <SelectContent>
                  <SelectItem value="admin">
                    <div className="flex flex-col">
                      ...
                      <span className="text-xs text-slate-400">Can manage employees, departments, members</span>
                    </div>
                  </SelectItem>
                  <SelectItem value="member">
                    <div className="flex flex-col">
                      <span className="font-medium">Member</span>
                      <span className="text-xs text-slate-400">Can view all data (read-only)</span>
                    </div>
                  </SelectItem>
                </SelectContent>
              </Select>
